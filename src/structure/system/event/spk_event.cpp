...
namespace spk
{
	...
	const std::unordered_map<UINT, Event::ConstructorLambda> Event::_constructionMap = {
		...
		{WM_SETFOCUS, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::TakeFocus; }},
		{WM_KILLFOCUS, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::LoseFocus; }},
		{WM_CLOSE, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::Quit; }},
		{WM_QUIT, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::Quit; }},
		{WM_ENTERSIZEMOVE,
		 [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::EnterResize; }},
		{WM_SIZE,
		 [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam)
		 {
		...
		{WM_SETCURSOR, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::SetCursor; }},
		{WM_EXITSIZEMOVE, [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam) { p_event->systemEvent.type = SystemEvent::Type::ExitResize; }},
		{WM_LEFT_JOYSTICK_MOTION,
		 [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam)
		 {
			 ...
			 p_event->controllerEvent.joystick.values =
				 spk::Vector2Int(static_cast<unsigned short>(wParam) - halfValue,
								 std::numeric_limits<unsigned short>::max() - static_cast<unsigned short>(lParam) - halfValue);
		 }},
		...
		{WM_DIRECTIONAL_CROSS_MOTION,
		 [](Event *p_event, UINT uMsg, WPARAM wParam, LPARAM lParam)
		 {
			 ...
			 p_event->controllerEvent.directionalCross.values =
				 spk::Vector2Int(static_cast<short>(LOWORD(lParam)), static_cast<short>(HIWORD(lParam)));
		 }},
