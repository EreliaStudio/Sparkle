...
namespace spk::Lumina
{
	...
	FunctionSymbol::FunctionSymbol(const std::wstring &p_name, const TypeSymbol *p_returnType, const std::vector<Variable> &p_parameters,
	...
	TypeSymbol::TypeSymbol(const std::wstring &p_name, Role p_role, NamespaceSymbol *p_parent) :
		name(p_name),
		parent(p_parent),
		role(p_role)
	{
	...
	void NamespaceSymbol::addFunction(TypeSymbol *p_returnType, const std::wstring &p_name, const std::vector<Variable> &p_parameters)
	{
		functions.emplace_back(p_name, p_returnType, p_parameters);
	}

	TypeSymbol *NamespaceSymbol::addType(const std::wstring &p_name, TypeSymbol::Role p_role)
	{
	...
	void TypeSymbol::addMethod(TypeSymbol *p_returnType, const std::wstring &p_methodName, const std::vector<Variable> &p_parameters)
	{
	...
	void TypeSymbol::addOperator(TypeSymbol *p_returnType, const std::wstring &p_operatorType, const std::vector<Variable> &p_parameters)
	{
