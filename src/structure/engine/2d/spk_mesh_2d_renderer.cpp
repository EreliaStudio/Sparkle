...
outputColor = texColor;
	...
	void Mesh2DRenderer::Painter::setTransform(const spk::Transform2D &p_transform)
	{
	...
	void Mesh2DRenderer::seGenericMesh(const spk::SafePointer<const spk::Mesh2D> &p_mesh)
	{
		_mesh = p_mesh;
		_painter.clear();
		if (_mesh != nullptr)
