...
namespace spk
{
    ...
    Mesh2D::VertexIndex::VertexIndex(size_t p_pointIndex, size_t p_uvIndex)
        : pointIndex(p_pointIndex), uvIndex(p_uvIndex)
    {
    }
    ...
    void Mesh2D::addFace(const VertexIndex& p_vertexA,
                         const VertexIndex& p_vertexB,
                         const VertexIndex& p_vertexC)
    {
