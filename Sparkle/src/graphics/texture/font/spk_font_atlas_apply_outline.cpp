...
namespace spk
{
     ...
     * @param p_outlineStyle The type of outline.
     * @return The appropriate pixel placement function.
     */
	PlacePixelFunction _requestPlacePixelFunction(const spk::Font::OutlineStyle& p_outlineStyle)
	{
	...
	{
		PlacePixelFunction placePixelFunction = _requestPlacePixelFunction(p_key.outlineStyle);
