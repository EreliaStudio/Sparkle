...
namespace spk
{
	...
	public:
		TileMap(const std::wstring &p_name, spk::SafePointer<spk::Entity2D> p_parent) :
			spk::Entity2D(p_name, p_parent)
		{
		}
