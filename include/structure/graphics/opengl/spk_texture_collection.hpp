...
namespace spk::OpenGL
{
	...
	public:
		static spk::SafePointer<spk::OpenGL::TextureObject> textureObject(const spk::SafePointer<const spk::Texture>& p_cpuTexture, std::unique_ptr<spk::OpenGL::TextureObject> p_gpuTexture = nullptr)
		{
			...
			std::unique_ptr<spk::OpenGL::TextureObject> newGPU = 
				(p_gpuTexture == nullptr ?
					std::make_unique<spk::OpenGL::TextureObject>() :
					std::move(p_gpuTexture)	
				);
