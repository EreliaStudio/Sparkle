...
namespace spk
{
	...
	public:
		struct Option
		{
			...
			Option(const std::wstring& p_longName, char p_shortName, const std::wstring& p_description, size_t p_arity = 0, std::optional<std::wstring> p_defaultVal = std::nullopt);
		};
